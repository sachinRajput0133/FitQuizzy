  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1 container max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold mb-6">About Fit Quizzy</h1>
        <div className="prose dark:prose-invert max-w-none">
          <p>
            Fit Quizzy is a platform dedicated to helping consumers find the perfect products for their needs through interactive quizzes and personalized recommendations.
          </p>
          <p>
          ...
          <p>
            Fit Quizzy participates in various affiliate marketing programs, which means we may earn commissions on products purchased through our links. This doesn't affect our recommendations, as we only suggest products we genuinely believe in.
          </p>
        </div>
      </main>
      {/* <SiteFooter /> */}
